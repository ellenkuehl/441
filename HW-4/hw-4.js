...
//
// Your code goes here
var squarePrintFuncDef = function(number) {
  console.log(number * number);
}
function squarePrintFuncExpress(number) {
  console.log(number * number);
};
...
// This problem was a little confusing to comprehend. I tried looking up extra information with no success. I did my best but was unable to complete this problem in full. My apologies. 
